...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        private ApiResponse<T> Exec<T>(RestRequest req, IReadableConfiguration configuration)
        {
            ...
            {
                client.AddHandler(() => existingDeserializer, "application/json", "text/json", "text/x-json", "text/javascript", "*+json", "application/octet-stream");
            }
            else
            {
                client.AddHandler(() => new CustomJsonCodec(configuration), "application/json", "text/json", "text/x-json", "text/javascript", "*+json", "application/octet-stream");
            }
