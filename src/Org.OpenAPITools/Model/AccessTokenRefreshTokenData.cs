...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AccessTokenRefreshTokenData :  IEquatable<AccessTokenRefreshTokenData>, IValidatableObject
    {
        ...
        public AccessTokenRefreshTokenData(string accessToken = default(string), string refreshToken = default(string))
        {
        ...
        {
            return this.Equals(input as AccessTokenRefreshTokenData);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(AccessTokenRefreshTokenData input)
        {
            if (input == null)
                return false;
