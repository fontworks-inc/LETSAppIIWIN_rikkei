...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObjectDeviceUpdateInfo : IEquatable<InlineObjectDeviceUpdateInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObjectDeviceUpdateInfo" /> class.
        /// </summary>
        /// <param name="offlineDeviceId">mailAddress.</param>
        /// <param name="indefiniteAccessToken">password.</param>
        public InlineObjectDeviceUpdateInfo(string offlineDeviceId = default(string), string indefiniteAccessToken = default(string), string hostname = default(string), string osUserName = default(string))
        {
        ...
        {
            return this.Equals(input as InlineObjectDeviceUpdateInfo);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(InlineObjectDeviceUpdateInfo input)
        {
            if (input == null)
                return false;
